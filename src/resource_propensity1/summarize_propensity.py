...
def main() -> int:
    ...
    parser.add_argument("--output-path", default=os.path.join(os.path.dirname(__file__), "propensity_outputs", "propensity_summary_by_band.csv"), help="Path to write summary table")
    ...
    auto_path = os.path.join(os.path.dirname(__file__), "propensity_outputs", "auto_explanations.csv")
    ...
    rationale_path = os.path.join(os.path.dirname(__file__), "propensity_outputs", "propensity_summary_with_rationale.csv")
